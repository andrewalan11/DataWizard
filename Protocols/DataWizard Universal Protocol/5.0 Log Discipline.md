...
**One decision log per project.** Unlike session logs (one per project) and harvest logs (one per document), the decision log is a single file for the whole project. It's the canonical record of the project's architectural evolution. Created at project bootstrap alongside 0.0, 0.1, and 0.2 — every project makes decisions worth recording.
