...
edit_log:
  ...
  - "DW-S349 2026-09-08 - model-casting row added (v1.0, new skill); 4 rows
...
| **transcript-harvest** (v0.9.2) | Technique | Harvesting content from transcripts (video, podcast, meeting, voice memo) into project documents: segmentation, chunk-and-route, block citations, batch mode. |
| **document-harvest** (v0.5.1) | Technique | Harvesting content from articles, clippings, and web content into project documents: triage-before-fetch, block citations, synth-note fan-out. |
